...
L.OWM.Current = L.Class.extend({
	...
	options: {
		appId: '84f16e9a6d5aa76227fb107e44bfdf16', // get your free Application ID at www.openweathermap.org
		type: 'city', // available types: 'city', 'station'
		lang: 'en', // available: 'en', 'de', 'ru', 'fr', 'nl', 'es', 'ca' (not every language is finished yet)
		minZoom: 7,
		interval: 15, // interval for rereading city/station data in minutes
...
L.OWM.ProgressControl = L.Control.extend({
	...
	initialize: function(options) {
		...
		this._container.innerHTML = '<img src="' + this.options.imageLoadingUrl + '" width="500" height="50" />';
	},
