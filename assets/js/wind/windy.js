...
var Windy = function( params ){
  var VELOCITY_SCALE = 0.0012;             // scale for wind velocity (completely arbitrary--this value looks nice)
  ...
  // var PARTICLE_LINE_WIDTH = 7;              // line width of a drawn particle
  ...
  var createWindBuilder = function(uComp, vComp) {
      ...
      console.log("panjang U"+uComp.data.length);
      console.log("panjang V"+vComp.data.length);

      return {
          header: uComp.header,
          //recipe: recipeFor("wind-" + uComp.header.surface1Value),
          data: function(i) {
              return [uData[i]*9 , vData[i]*9];
          },
  ...
  var createBuilder = function(data) {
      ...
      data.forEach(function(record) {
        // kalo pake data dari earthschool (wind-js original)
        ...
        // klo pake data wind dari windity API
        //gopalgopel 2015
          // switch (record.header.name) {
          //     case "UGRD": uComp = record; break;
          //     case "VGRD": vComp = record; break;
          //     default:
          //       scalar = record;
          // }
          switch (record.header.parameterNumberName) {
              case "U-component_of_wind": uComp = record; break;
              case "V-component_of_wind": vComp = record; break;
              default:
                scalar = record;
          }
        //gopalgopel 2015
